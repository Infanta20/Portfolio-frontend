  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <section className="text-center py-20 bg-gradient-to-red from-blue-500 to-purple-600 text-white rounded-lg">
        <h1 className="text-5xl font-bold mb-4 text-black">Hi, I'm Infanta, a Mern Stack Developer</h1>
        <p className="text-xl text-black">Building modern web applications with React, Node.js, and MongoDB</p>
      </section>
      ...
      <section className="my-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {['HTML','CSS','Tailwind CSS','JavaScript','React', 'Node.js', 'Express','MongoDB','Firebase','Python','Git','GitHub'].map(skill => (
